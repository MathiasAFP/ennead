...
const indicators = [
  {
    ...
    value: "12",
    detail: "4 em análise agora",
    icon: Ticket,
  },
  {
    label: "Resolvidos hoje",
    value: "8",
    detail: "Tempo médio menor",
    icon: CheckCircle2,
  },
  {
    label: "Casos semelhantes encontrados",
    value: "34",
    detail: "Nesta semana",
    icon: History,
  },
                ...
                <table className="w-full table-fixed border-collapse text-left">
                  <thead>
                    <tr className="border-b border-slate-100 bg-slate-50/80 text-xs uppercase text-slate-500">
                      <th className="w-[72px] px-4 py-3 font-semibold">ID</th>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {recentTickets.map((ticket) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3">
                          <button
                            aria-label={`Abrir ações do chamado ${ticket.id}`}
            ...
            <aside className="flex flex-col gap-4">
              <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm shadow-slate-200/60">
                ...
                <h2 className="mt-2 text-xl font-semibold leading-7 tracking-normal text-slate-950">
                  34 atendimentos anteriores ajudaram na resolução de novos
